...
import com.flipkart.fashion.wire.JsonToEntityMarshaller

import scala.collection.immutable.Seq

abstract class BaseHandler extends Directives with PredefinedFromEntityUnmarshallers with PredefinedToEntityMarshallers with JsonToEntityMarshaller {
